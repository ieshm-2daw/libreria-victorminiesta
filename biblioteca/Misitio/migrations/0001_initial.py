    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('disponibilidad', models.CharField(choices=[('disponible', 'Disponible'), ('reservado', 'Reservado'), ('prestamo', 'Prestamo')], default='disponible', max_length=20)),
                ('portada', models.ImageField(blank=True, null=True, upload_to='portadas/')),
                ('editorial', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Misitio.editorial')),
            ],
        ),
    ]
